...
if (singleFigure == true)
    %..........................
    P(1) = plot(h1,nan,nan,"-g");

    xlabel(h1,"x (metres)")
    ylabel(h1,"y (metres)")

    legend1 = legend(P(:),{"desired path","vehicle path","initial position"})
    set(legend1,'Location','northeastoutside');
    axis(ax1,'square')
    text(h1,x0-17,y0-8,"$(P_{x_0}, P_{y_0})$",'Color','red','BackgroundColor', [1, 1, 1, 0.5],'FontSize',12,'Interpreter','latex')
