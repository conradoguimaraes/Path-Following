...
PB1y = PA1y;
LineA1B1x = PA1x:PB1x;
LineA1B1y = PA1y*ones(1,length(LineA1B1x));
...
PC1y = PB2y+270;
LineB2C1y = PB2y:PC1y;
LineB2C1x = PB2x*ones(1,length(LineB2C1y));
...
PD1y = PC2y;
LineC2D1x = PD1x:PC2x;
LineC2D1y = PD1y*ones(1,length(LineC2D1x));
...
PE1y = PD2y+200;
LineD2E1y = PD2y:PE1y;
LineD2E1x = PD2x*ones(1,length(LineD2E1y));
...
PF1y = PE2y;
LineE2F1x = PE2x:PF1x;
LineE2F1y = PF1y*ones(1,length(LineE2F1x));
...
PG1y = PF2y+200;
LineF2G1y = PF2y:PG1y;
LineF2G1x = PG1x*ones(1,length(LineF2G1y));
...
PH1y = PG2y;
LineG2H1x = PH1x:PG2x;
LineG2H1y = PH1y*ones(1,length(LineG2H1x));
...
PI1y = PH2y-580;
LineH2I1y = PI1y:PH2y;
LineH2I1x = PI1x*ones(1,length(LineH2I1y));
...
PJ1y = PI2y + 580;
LineI2J1y = PI2y:PJ1y;
LineI2J1x = PJ1x*ones(1,length(LineI2J1y));
...
PA2y = Yarc1(1);
LineJ2A2y = PA2y:PJ2y;
LineJ2A2x = PA2x*ones(1,length(LineJ2A2y));
